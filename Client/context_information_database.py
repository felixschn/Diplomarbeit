...
def update_context_information_security_mechanisms_information(mechanisms_information_update_message):
    db_cursor = get_cursor()
    create_mechanisms_information_query = """CREATE TABLE if not exists 
    context_information_security_mechanims_information(mechanism_name, modes)"""
...
def update_context_information_keystore(keystore_update_message):
    ...
    create_keystore_query = """CREATE TABLE if not exists context_information_keystore(keyname,minimum_value,
    maximum_value,desirable_value,weight,separatorlist)"""
